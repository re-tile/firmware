...
/**
 * op_replace_proc_self_exe_filename - construct pathname of sibling program
 * @param tail	       - basename of sibling executable
 *
 * Digs up the pathname of the current executable and replaces the
 * final component witht the given new tail.
 */ 
std::string op_replace_proc_self_exe_filename(std::string const& tail);
