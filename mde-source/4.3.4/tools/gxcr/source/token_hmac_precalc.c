                   ...
                   int data_size)
{
  ...
  *(tkn + HMAC_PRECALC_CTX_ACC_OFFSET) =
  ...
  gxcr_write_context_control_words(&bs_ccw, tkn + HMAC_PRECALC_CCW_OFFSET);
                           ...
                           void* data_mem, int data_mem_len)
{
  ...
  gxio_mica_start_op(mica_context, data_mem, data_mem, metadata_mem,
                     opcode_oplen);
}
...
hmac_precalc_process(gxio_mica_context_t* mica_context,
                     ...
                     void* data_mem, int data_mem_len)
{
  hmac_precalc_process_start(mica_context, metadata_mem, metadata_mem_len,
                             data_mem, data_mem_len);
