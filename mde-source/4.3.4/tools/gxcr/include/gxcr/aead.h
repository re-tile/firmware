...
typedef struct
{
  ...
  /** True if using AES-GCM algorithm. */
  bool aes_gcm;
...
gxcr_aead_context_key(gxcr_aead_context_t* aead_context)
{
 ...
 */
static __inline void*
gxcr_aead_context_iv(gxcr_aead_context_t* aead_context)
{
  return aead_context->metadata_mem +
    aead_context->token_info.iv_offset;
}
 ...
 */
static __inline void*
gxcr_aead_context_digest0(gxcr_aead_context_t* aead_context)
{
  return aead_context->metadata_mem +
 ...
 */
static __inline void*
gxcr_aead_context_digest1(gxcr_aead_context_t* aead_context)
{
  return aead_context->metadata_mem + 
...
gxcr_aead_result(gxcr_aead_context_t* aead_context)
{
  return (gxcr_result_token_t*)(aead_context->metadata_mem +
                                (aead_context->token_info.total_len_div_8 << 3));
}
