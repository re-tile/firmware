 ...
 * @param inter_cpu CPU number of interrupt will be delivered.
 * @param inter_event Sub-interrupt event bit number; a negative value can
 *  disable the interrupt.
 * @return Zero if all of the requested UART events were successfully
 *  configured to interrupt.
 */
extern int
gxio_uart_cfg_interrupt(gxio_uart_context_t* context,
                        int inter_cpu,
                        int inter_event);
