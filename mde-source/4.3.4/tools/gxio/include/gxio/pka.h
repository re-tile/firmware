 ...
 * Remainder Theorem), Modular inversion, Elliptic Curve point
 ...
 */
extern int
gxio_mica_pka_cfg_cmd_queue_empty_interrupt(gxio_mica_pka_context_t* context,
 ...
 */
extern int
gxio_mica_pka_cfg_res_queue_full_interrupt(gxio_mica_pka_context_t* context,
                                            int target_cpu, int target_event,
                                            int ring);
