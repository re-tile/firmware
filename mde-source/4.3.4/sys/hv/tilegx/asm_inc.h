...
#ifndef _SYS_HV_TILEGX_ASM_INC_H
#define _SYS_HV_TILEGX_ASM_INC_H
...
#define BUNDLE_SIZE     8       ///< Bytes per instruction bundle
	...
	// last thing that gets pushed gets pushed with "sw sp, <foo>" rather
	...
	store_and_inc \local_base, tp, _asm_inc_extra_align
...
panic_str:
	...
	// r2      1, to set ICS SPR.
	// r3      Value for the AAR.
	// r4-r7   Address values from the table (see comment below).
        // r8-r11  Destinations for the loads.
	//
...
#endif /* _SYS_HV_TILEGX_ASM_INC_H */
