...
/** @defgroup gxio_mpipe_link_open_flags Link Open Flags
 *  @ingroup gxio_mpipe_link
 */
 ...
 */
#ifdef __DOXYGEN_API_REF__
/** See @ref gxio_mpipe_link_perm for a full description of link permissions.
 */
#endif
...
/** @defgroup gxio_mpipe_link_attrs Link Attributes
 *  @ingroup gxio_mpipe_link
 */
...
#ifdef __DOXYGEN_API_REF__
/** Note that in order to receive jumbo frames, applications must also
 *  supply approprately sized buffers, and configure appropriate packet
 *  size limits with the gxio_mpipe_rules API. */
#endif
 ...
 *  gxio_mpipe_link_get_attr(); it may not be modified. */
#ifdef __DOXYGEN_API_REF__
/** See @ref gxio_mpipe_link_state_flags for a full description of the
 *  legal flags. */
#endif
...
#ifdef __DOXYGEN_API_REF__
/** See @ref gxio_mpipe_module_type_values for a full description of the
 *  legal types. */
#endif
#define GXIO_MPIPE_LINK_MODULE_TYPE        0x090000
...
/** @defgroup gxio_mpipe_link_lattrs Link Long Attributes
 *  @ingroup gxio_mpipe_link
 */
...
/*
 * Note: long link attributes must fit in 8 bits, since the API explicitly
 * contains a 16-bit offset field and we use the remaining 8 bits of the
 * IORPC offset word for the channel number.
 */

/** Module EEPROM contents.  For all modules, the first 256 bytes will be
 *  the contents of the module EEPROM; for modules that support SFF-8472,
 *  the following 256 bytes will be the content of the dynamic optical
 *  monitoring registers. */
#define GXIO_MPIPE_LINK_MODULE_EEPROM      0x01
...
/** @defgroup gxio_mpipe_link_stat_config Statistics configuration
 *  @ingroup gxio_mpipe_link
 */
...
/** @defgroup gxio_mpipe_link_state_flags Link State Flags
 *  @ingroup gxio_mpipe_link
 */
...
/** @defgroup gxio_mpipe_module_type_values Module Types
 *  @ingroup gxio_mpipe_link
 */
...
/** Link does not have an associated pluggable module. */
#define GXIO_MPIPE_LINK_MODULE_NONE 0

/** Link has a pluggable module conforming to SFF-8079 but not SFF-8472
 *  (i.e., does not provide dynamic optical monitoring information). */
#define GXIO_MPIPE_LINK_MODULE_8079 1

/** Link has a pluggable module conforming to SFF-8472 (i.e., provides
 *  dynamic optical monitoring information). */
#define GXIO_MPIPE_LINK_MODULE_8472 2
